...
class DetailEventPage(QWidget):
    ...
    def setup_ui(self):
        ...
        # path gambar icon
        icon_path = asset_path("assets", "icons", "arrow_back.png")
        ...
        try:
            self.btn_love.setIcon(QIcon(asset_path("assets", "icons", "unliked.png")))
        except Exception:
            pass
        ...
        lokasi_pixmap = QPixmap(asset_path("assets", "icons", "place.png"))
        ...
        waktu_pixmap = QPixmap(asset_path("assets", "icons", "clock.png"))
        ...
        home_pixmap = QPixmap(asset_path("assets", "icons", "universitas.png"))
        ...
        tiket_pixmap = QPixmap(asset_path("assets", "icons", "ticket.png"))
    ...
    def set_data(self, data):
        ...
        try:
            self.btn_love.setIcon(QIcon(asset_path("assets", "icons", icon_path)))
        except Exception:
            pass
